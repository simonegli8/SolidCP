...
dotnet ef migrations remove --framework net8.0 --no-build --context SqlServerDbContext -- "DbType=SqlServer;Server=(local);Initial Catalog=SolidCP;Uid=sa;Pwd=Password12;"
...
dotnet ef migrations script --framework net8.0 --no-build -o Migrations\SqlServer\install.sqlserver.sql --context SqlServerDbContext -i -- "DbType=SqlServer;Server=(local);Initial Catalog=SolidCP;Uid=sa;Pwd=Password12;"
