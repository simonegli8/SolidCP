...
dotnet ef migrations remove --framework net8.0 --no-build --context SqlServerDbContext -- "DbType=SqlServer;Server=(local);Initial Catalog=SolidCP;Uid=sa;Pwd=Password12;;TrustServerCertificate=true"
...
dotnet ef migrations remove --framework net8.0 --no-build --context PostgreSqlDbContext -- "DbType=PostgreSql;Host=localhost;User ID=postgres;Password=Password12;Port=5432;Database=SolidCP;"
...
dotnet ef migrations script --framework net8.0 --no-build -o Migrations\SqlServer\install.sqlserver.sql --context SqlServerDbContext -i -- "DbType=SqlServer;Server=(local);Initial Catalog=SolidCP;Uid=sa;Pwd=Password12;;TrustServerCertificate=true"
...
dotnet ef migrations script --framework net8.0 --no-build -o Migrations\PostgreSql\install.postgresql.sql --context PostgreSqlDbContext -i -- "DbType=PostgreSql;Host=localhost;User ID=postgres;Password=Password12;Port=5432;Database=SolidCP;"
...
REM dotnet ef migrations bundle --framework net8.0 --no-build -o Migrations\SqlServer\install.sqlserver.bundle.exe --context SqlServerDbContext -- "DbType=SqlServer;Server=(local);Initial Catalog=SolidCP;Uid=sa;Pwd=Password12;"
